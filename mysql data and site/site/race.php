  ...
  <li class="disabled"><a href="http://rbkbrigades.com/forums/">Forums</a></li>
            ...
            <ul class="nav">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a id="kills" href="kills.php">Kills</a>
                  </li>
                  <li>
                    <a id="deaths" href="deaths.php">Deaths</a>
                  </li>
                  <li>
                    <a id="race" href="race.php">Racers</a>
                  </li>
                  <li>
                    <a id="level" href="level.php">Level</a>
                  </li>
                </ul>
              </li>
            </ul>
	...
	<div class="whmcscontainer">
		<div class="contentpadded">
			...
			<table width='480' border='1%' cellspacing='1' style='border-collapse: collapse;'>
				<tr>
					<td style="background-color: #404040; font-color: white;">
						<center><font color="white"><center>Rank</td><td style="background-color: #404040; font-color: white;" ><center><font color="white"><center>Nick</td><td style="background-color: #404040; font-color: white;" ><center><font color="white"><center>Points</td></tr>
	<?php
	// Conexão com o Banco de Dados
	mysql_connect('localhost', 'root', 'password') or die(mysql_error());

	// Seleciona o Banco de Dados
	mysql_select_db("battlefield") or die(mysql_error());

	//query SQL
	$strSQL = "SELECT * FROM `accounts` ORDER BY `RacePoints` DESC LIMIT 0,15 ";
	...
	while($row = mysql_fetch_array($rs)) {
	 ...
	 $listar++;
	  ...
	  echo "<tr width='480'>"."<font color='blue'><th width=60>".$cont."</th></font>
							<th width=205> ".$row['Username']."</th>
							<center>
								<th>".$row['RacePoints']."</th>
				</tr>"; } // Encerra a conexão mysql_close(); ?>
			</table>
		</div>
		...
		<div class="whmcscontainer">
			<div class="footer">
				<div id="copyright">Copyright &copy; 2015 Battlefield. All rights reserved.</div>
				<div class="clear"></div>
			</div>
		</div>
