...
(adsbygoogle = window.adsbygoogle || []).push({});
  ...
  <li class="disabled"><a href="http://rbkbrigades.com/forums/">Forums</a></li>
			...
			<table width='480' border='1%' cellspacing='1' style='border-collapse: collapse;'>
				<tr>
					<td style="background-color: #404040; font-color: white;">
						<center><font color="white"><center>Rank</td><td style="background-color: #404040; font-color: white;" ><center><font color="white"><center>Nick</td><td style="background-color: #404040; font-color: white;" ><center><font color="white"><center>Level</td></tr>
	<?php
	...
	//query SQL
	$strSQL = "SELECT * FROM `accounts` ORDER BY `Level` DESC LIMIT 0,15 ";
